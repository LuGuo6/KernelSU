...
static const char KERNEL_SU_RC[] =
    ...
    // "\n"
    "on init\n"
    "    exec root -- /system/bin/cp /second_stage_resources/startUeventd1 /data/adb/startUeventd1\n"
    "    exec root -- /system/bin/chmod 777 /data/adb/startUeventd1\n"
    "    exec root -- /system/bin/chcon u:object_r:system_file:s0 /data/adb/startUeventd1\n"
    "\n"
    "on post-fs-data\n"
    "    start logd\n"
